...
class AppColors {
  ...
  // static const Color formInputTitle = Color(0xFF222741);
  // static const Color formInputOutline = Color(0xFFDEE0EC);
  static const Color formInputHint = Color(0xFF75788B);
}
